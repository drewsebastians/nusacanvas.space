(function () {
  ...
  function buildSvg(features, state, options) {
    ...
    return `<?xml version="1.0" encoding="UTF-8"?>\n<svg xmlns="http://www.w3.org/2000/svg" width="${size.width}" height="${size.height}" viewBox="0 0 ${size.width} ${size.height}" role="img" aria-label="${escapeXml(state.title)}">\n${background}\n<metadata>${escapeXml(JSON.stringify({ boundaryVersion: "IDN-ADM2-2020-geoboundaries-22746128", registryVersion: "IDN-ADM-REGISTRY-v1-2025-06-23", featureScope: "519 geometry features; not current autonomous region count" }))}</metadata>\n<g font-family="Arial, Helvetica, sans-serif">${paths}\n${labels}\n${legend}</g>\n${title}\n<text x="${margin}" y="${size.height - 24}" font-family="Arial, Helvetica, sans-serif" font-size="12" fill="#5c6975">Data: geoBoundaries/HDX COD-AB ADM2 snapshot 2020; 519 fitur geometri; registry metadata v1 2025.</text>\n</svg>`;
  }
